<%-- 
    ...
    Created on : Oct 17, 2025, 6:55:13 PM
    Author     : DELL
--%>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editBookForm" action="${pageContext.request.contextPath}/admin/product?action=edit" method="POST" enctype="multipart/form-data">
                    <!--id-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <select class="custom-select" id="categoryEditInput" name="category">
                                <c:forEach items="${listAdminCategory}" var="category">
